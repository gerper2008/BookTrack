...
CREATE OR REPLACE PACKAGE BODY PC_CATEGORIA IS
    ...
    BEGIN
        UPDATE Categoria SET nombre = xNOMBRE, descripcion = xDESCRIPCION WHERE id = xID;
        COMMIT;
    EXCEPTION
        WHEN OTHERS THEN ROLLBACK;
    ...
    FUNCTION CO_CATEGORIA RETURN SYS_REFCURSOR IS
        cur SYS_REFCURSOR;
    BEGIN
        OPEN cur FOR SELECT * FROM Categoria;
        RETURN cur;
    END CO_CATEGORIA;
...
CREATE OR REPLACE PACKAGE BODY PC_AUTOR IS
    ...
    BEGIN
        UPDATE Autor SET nombre = xNOMBRE, apellidos = xAPELLIDOS, genero = xGENERO, nacionalidad = xNACIONALIDAD WHERE id = xID;
        COMMIT;
    EXCEPTION
        WHEN OTHERS THEN ROLLBACK;
    ...
    FUNCTION CO_AUTOR RETURN SYS_REFCURSOR IS
        cur SYS_REFCURSOR;
    BEGIN
        OPEN cur FOR SELECT * FROM Autor;
        RETURN cur;
    END CO_AUTOR;
...
CREATE OR REPLACE PACKAGE BODY PC_EDITORIAL IS
    ...
    BEGIN
        ...
        VALUES ('EDT' || LPAD(SQ_EDITORIAL.NEXTVAL, 3, '0'), xNOMBRE, xCORREO, xTELEFONO, xPAIS);
        COMMIT;
    EXCEPTION
        WHEN OTHERS THEN ROLLBACK;
    ...
    BEGIN
        UPDATE Editorial SET nombre = xNOMBRE, correo = xCORREO, telefono = xTELEFONO, pais = xPAIS WHERE id = xID;
        COMMIT;
    EXCEPTION
        WHEN OTHERS THEN ROLLBACK;
    ...
    FUNCTION CO_EDITORIAL RETURN SYS_REFCURSOR IS
        cur SYS_REFCURSOR;
    BEGIN
        OPEN cur FOR SELECT * FROM Editorial;
        RETURN cur;
    END CO_EDITORIAL;
...
CREATE OR REPLACE PACKAGE BODY PC_LIBRO IS
    ...
    BEGIN
        UPDATE Libro SET idCategoria = xIDCATEGORIA, titulo = xTITULO, descripcion = xDESCRIPCION, idioma = xIDIOMA WHERE id = xID;
        COMMIT;
    EXCEPTION
        WHEN OTHERS THEN ROLLBACK;
    ...
    BEGIN
        INSERT INTO Libro_Autor(idLibro, idAutor) VALUES (xIDLIBRO, xIDAUTOR);
        COMMIT;
    EXCEPTION
        WHEN OTHERS THEN ROLLBACK;
    ...
    FUNCTION CO_LIBRO RETURN SYS_REFCURSOR IS
        cur SYS_REFCURSOR;
    BEGIN
        OPEN cur FOR SELECT * FROM Libro;
        RETURN cur;
    END CO_LIBRO;
    ...
    FUNCTION CO_LIBRO_CAT(xIDCATEGORIA IN VARCHAR2) RETURN SYS_REFCURSOR IS
        cur SYS_REFCURSOR;
    BEGIN
        OPEN cur FOR SELECT * FROM Libro WHERE idCategoria = xIDCATEGORIA;
        RETURN cur;
    END CO_LIBRO_CAT;
...
CREATE OR REPLACE PACKAGE BODY PC_EDICION IS
    ...
    BEGIN
        ...
        VALUES ('EDI' || LPAD(SQ_EDICION.NEXTVAL, 3, '0'), xIDLIBRO, xIDEDITORIAL, xANIO, xPAGINAS);
        COMMIT;
    EXCEPTION
        WHEN OTHERS THEN ROLLBACK;
    ...
    BEGIN
        UPDATE Edicion SET idLibro = xIDLIBRO, idEditorial = xIDEDITORIAL, anio = xANIO, paginas = xPAGINAS WHERE id = xID;
        COMMIT;
    EXCEPTION
        WHEN OTHERS THEN ROLLBACK;
    ...
    FUNCTION CO_EDICION RETURN SYS_REFCURSOR IS
        cur SYS_REFCURSOR;
    BEGIN
        OPEN cur FOR SELECT * FROM Edicion;
        RETURN cur;
    END CO_EDICION;
    ...
    FUNCTION CO_EDICION_LIBRO(xIDLIBRO IN VARCHAR2) RETURN SYS_REFCURSOR IS
        cur SYS_REFCURSOR;
    BEGIN
        OPEN cur FOR SELECT * FROM Edicion WHERE idLibro = xIDLIBRO;
        RETURN cur;
...
CREATE OR REPLACE PACKAGE BODY PC_EJEMPLAR IS
    ...
    BEGIN
        UPDATE Ejemplar SET estadoFisico = xESTADOFISICO, disponibilidad = xDISPONIBILIDAD, localizacion = xLOCALIZACION WHERE id = xID;
        COMMIT;
    EXCEPTION
        WHEN OTHERS THEN ROLLBACK;
    ...
    FUNCTION CO_EJEMPLAR RETURN SYS_REFCURSOR IS
        cur SYS_REFCURSOR;
    BEGIN
        OPEN cur FOR SELECT * FROM Ejemplar;
        RETURN cur;
    END CO_EJEMPLAR;
    ...
    FUNCTION CO_EJEMPLAR_EDICION(xIDEDICION IN VARCHAR2) RETURN SYS_REFCURSOR IS
        cur SYS_REFCURSOR;
    BEGIN
        OPEN cur FOR SELECT * FROM Ejemplar WHERE idEdicion = xIDEDICION;
        RETURN cur;
...
CREATE OR REPLACE PACKAGE BODY PC_PROVEEDOR IS
    ...
    BEGIN
        ...
        VALUES ('PRV' || LPAD(SQ_PROVEEDOR.NEXTVAL, 3, '0'), xNOMBRE, xAPELLIDOS, xCORREO, xEMPRESA, xTELEFONO);
        COMMIT;
    EXCEPTION
        WHEN OTHERS THEN ROLLBACK;
    ...
    BEGIN
        UPDATE Proveedor SET nombre = xNOMBRE, apellidos = xAPELLIDOS, correo = xCORREO, empresa = xEMPRESA, telefono = xTELEFONO WHERE id = xID;
        COMMIT;
    EXCEPTION
        WHEN OTHERS THEN ROLLBACK;
    ...
    FUNCTION CO_PROVEEDOR RETURN SYS_REFCURSOR IS
        cur SYS_REFCURSOR;
    BEGIN
        OPEN cur FOR SELECT * FROM Proveedor;
        RETURN cur;
    END CO_PROVEEDOR;
...
CREATE OR REPLACE PACKAGE BODY PC_COMPRA IS
    ...
    BEGIN
        UPDATE Compra SET fecha = xFECHA, total = xTOTAL, estado = xESTADO WHERE id = xID;
        COMMIT;
    EXCEPTION
        WHEN OTHERS THEN ROLLBACK;
    ...
    FUNCTION CO_COMPRA RETURN SYS_REFCURSOR IS
        cur SYS_REFCURSOR;
    BEGIN
        OPEN cur FOR SELECT * FROM Compra;
        RETURN cur;
    END CO_COMPRA;
    ...
    FUNCTION CO_PRODUCTOS_COMPRA(xIDCOMPRA IN VARCHAR2) RETURN SYS_REFCURSOR IS
        cur SYS_REFCURSOR;
    BEGIN
        OPEN cur FOR SELECT * FROM Producto_Compra WHERE idCompra = xIDCOMPRA;
        RETURN cur;
...
CREATE OR REPLACE PACKAGE BODY PC_USUARIO IS
    ...
    BEGIN
        UPDATE Usuario SET correo = xCORREO, nombre = xNOMBRE, apellidos = xAPELLIDOS, telefono = xTELEFONO WHERE id = xID;
        COMMIT;
    EXCEPTION
        WHEN OTHERS THEN ROLLBACK;
    ...
    BEGIN
        INSERT INTO Administrador(idUsuario, permisos, sede) VALUES (xIDUSUARIO, xPERMISOS, xSEDE);
        COMMIT;
    EXCEPTION
        WHEN OTHERS THEN ROLLBACK;
    ...
    BEGIN
        UPDATE Administrador SET permisos = xPERMISOS, sede = xSEDE WHERE idUsuario = xIDUSUARIO;
        COMMIT;
    EXCEPTION
        WHEN OTHERS THEN ROLLBACK;
    ...
    FUNCTION CO_USUARIOS RETURN SYS_REFCURSOR IS
        cur SYS_REFCURSOR;
    BEGIN
        OPEN cur FOR SELECT * FROM Usuario;
        RETURN cur;
    END CO_USUARIOS;
    ...
    FUNCTION CO_USUARIO_ROL(xROL IN VARCHAR2) RETURN SYS_REFCURSOR IS
        cur SYS_REFCURSOR;
    BEGIN
        OPEN cur FOR SELECT * FROM Usuario WHERE rol = xROL;
        RETURN cur;
    END CO_USUARIO_ROL;
    ...
    BEGIN
        OPEN cur FOR
            ...
            FROM Usuario u JOIN Administrador a ON u.id = a.idUsuario;
        RETURN cur;
