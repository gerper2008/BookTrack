...
-- Usuario
ALTER TABLE Usuario ADD CONSTRAINT CHECK_Usuario_nombre CHECK (REGEXP_LIKE(nombre, '^[A-Za-z0-9áéíóúÁÉÍÓÚüÜñÑ #.-]+$'));
ALTER TABLE Usuario ADD CONSTRAINT CHECK_Usuario_apellidos CHECK (REGEXP_LIKE(apellidos, '^[A-Za-z0-9áéíóúÁÉÍÓÚüÜñÑ #.-]+$'));
...
ALTER TABLE Proveedor ADD CONSTRAINT CHECK_Proveedor_nombre CHECK (REGEXP_LIKE(nombre, '^[A-Za-z0-9áéíóúÁÉÍÓÚüÜñÑ #.-]+$'));
